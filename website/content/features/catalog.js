...
export const CATALOG = [
  ...
  { slug: "karma-attack",         title: "Karma Attack",        category: "wifi",     summary: "Detect nearby probe requests and lure devices with fake APs — three variants: Captive (open AP + phishing portal), EAPOL (paired WPA2 device for handshake capture), and Support (companion role, hosts fake WPA2 over ESP-NOW)", hasDetail: true },
